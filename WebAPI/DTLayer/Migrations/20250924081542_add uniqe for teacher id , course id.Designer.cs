...
namespace DTLayer.Migrations
{
    ...
    [Migration("20250924081542_add uniqe for teacher id , course id")]
    partial class adduniqeforteacheridcourseid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DTLayer.Entities.TeacherCourses", b =>
                {
                    b.HasOne("DTLayer.Entities.Courses", "course")
                        .WithMany("teacherCourses")
                        .HasForeignKey("courseID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DTLayer.Entities.Teachers", "teacher")
                        .WithMany("teacherCourses")
